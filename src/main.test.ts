...
describe("test plugin", () => {
  ...
  test("?uint8array", () => {
    ...
    expect(hash(uint8array.buffer as ArrayBuffer)).toEqual("7167f7caac27a336c58b0c16cc5003d7")
  })
  ...
  test("?uint8array&base64", () => {
    ...
    expect(hash(uint8arrayB64.buffer as ArrayBuffer)).toEqual(
      "7167f7caac27a336c58b0c16cc5003d7"
    )
  })
})
